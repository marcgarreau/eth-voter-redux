...
A simple voting application as a playground for React/Redux and Solidity.
![](http://g.recordit.co/KwzZ9aUOqo.gif)

This application used this [accelerator](https://github.com/marcgarreau/accelerator) project as a starting point. The remainder of the `README` is generated by that repository.
